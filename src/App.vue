...
*:focus-visible {
  outline: 3px solid var(--color-primary);
  outline-offset: 2px;
  box-shadow: 0 0 0 1px rgba(23, 23, 25, 0.1);
}
...
.v-btn:focus-visible {
  ...
  box-shadow: 0 0 0 1px rgba(23, 23, 25, 0.1) !important;
}
